...
},{"./Player":159,"./Timeline":160}],162:[function(require,module,exports){
'use strict';

require('./client/parallax');

require('./client/contactForm');

},{"./client/contactForm":163,"./client/parallax":164}],163:[function(require,module,exports){
'use strict';
...
var _Form = require('./../../shared/client/react/Form');

var _Form2 = _interopRequireDefault(_Form);

var _Input = require('./../../shared/client/react/Input');

var _Input2 = _interopRequireDefault(_Input);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var formContainer = document.getElementById('form-contact-container');
...
function renderForm(c) {
    _reactDom2.default.render(_react2.default.createElement(
        _Form2.default,
        null,
        _react2.default.createElement(_Input2.default, { placeholder: 'Name', value: c.get('name'), name: 'name', onChange: onContactChange }),
        _react2.default.createElement(_Input2.default, { type: 'email', placeholder: 'E-Mail Address', value: c.get('e-mail'), name: 'e-mail', onChange: onContactChange }),
        _react2.default.createElement(_Input2.default, { placeholder: 'Company', value: c.get('company'), name: 'company', onChange: onContactChange })
    ), formContainer);
}

renderForm(contact);

},{"./../../shared/client/react/Form":165,"./../../shared/client/react/Input":166,"react":158,"react-dom":2}],164:[function(require,module,exports){
'use strict';
...
function parallax() {
    ...
    return (0, _rotoscope.createRotoscope)(window).bounds({
        start: 0,
        ...
        function animateSiteHeaderBackground(time) {
            var base = 0.5;
            var dist = 1 - base;
            var opacity = base + time * dist;
            var background = 'rgba(0, 23, 50, ' + opacity + ')';
...
},{"rotoscope":161}],165:[function(require,module,exports){
'use strict';
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'form',
                _extends({}, this.props, { onSubmit: this.onSubmit }),
                this.props.children
            );
        }
    }]);
...
exports.default = function (_ref) {
    ...
    return _react2.default.createElement('input', { placeholder: placeholder, value: value, type: type, onChange: onInputChange });
};
